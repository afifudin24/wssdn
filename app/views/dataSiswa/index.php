...
<body>
    ...
    <div style="padding: 0 15px;" class="mt-3">
        ...
        <a class="btn btn-primary" href="<?= BASEURL ?>/dataSiswa/form-simpan">Tambah Siswa <i
                    ...
                    <tr>
                        ...
                        <td class="align-middle  text-center ">
                            <a class="btn btn-warning"
                                href="<?= BASEURL ?>/dataSiswa/form-ubah/<?= $data['id'] ?>">Ubah</a>
            ...
            `);
                ...
                $('.delete-button').click(function() {
                    ...
                    modal.find('#confirmDeleteButton').attr('data-href',
                        '<?= BASEURL ?>/dataSiswa/hapus_data/' + id);
                    modal.modal('show');
                });
